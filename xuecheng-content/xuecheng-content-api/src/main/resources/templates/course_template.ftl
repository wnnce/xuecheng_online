        ...
        <div class="banner-info">
            <div class="banner-left">
                ...
                <p class="info">
                    ...
                    <span><em>难度等级</em>
                    <#if course.courseBase.grade == '204001'>
                        初级
                    <#elseif course.courseBase.grade == '204002'>
                        中级
                    <#elseif course.courseBase.grade == '204003'>
                        高级
                    <#else >
                        未知
                    </#if>
                    ...
                    <span><em>授课模式</em>
                    <#if course.courseBase.teachmode == '200002'>
                        录播
                    <#elseif course.courseBase.teachmode == '200003'>
                        直播
                    <#else >
                        未知
                    </#if>
            ...
            <div class="banner-rit">
                <p>
                  <a href="http://www.xuecheng.ml/course/preview/learning.html?id=${course.courseBase.id}" target="_blank">
        ...
        <div class="article-box">
                    ...
                    <div class="article-left-box">
                        <div class="content">
                          ...
                          <div class="content-com about">
                            ...
                            <div class="cont cktop">
                              <div >
                                <p>${course.courseBase.description!''}</p>
                              </div>
                              <!--<span class="on-off">更多 <i class="i-chevron-bot"></i></span>-->
                            </div>
                          </div>
            ...
            <div class="articleItem" style="display: none">
                <div class="article-cont-catalog">
                    <div class="article-left-box">
                        <div class="content">
                            <#list course.teachPlanList as teachPlan>
                                <div class="item">
                                    <div class="title act"><i class="i-chevron-top"></i>${teachPlan.pname}<span class="time">${teachPlan.timelength!''}</span></div>
                                    <div class="about">${teachPlan.description!''}</div>
                                    <div class="drop-down" style="height: 260px;">
                                        <ul class="list-box">
                                            <#list  teachPlan.teachPlanTreeNodes as teachNode>
                                            <li class="active"><a href="http://www.xuecheng.ml/course/preview/learning.html?id=${teachNode.courseId}&chapter=${teachNode.id}" target=_blank>${teachNode.pname!''}</a> <span>${teachNode.timelength!''}</span></li>
                                            </#list >
                                        </ul>
                                    </div>
                                </div>
